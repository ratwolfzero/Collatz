...
Note: Although the sequence theoretically enters the infinite cycle (1,4,2,1) once it reaches 1, our implementation  
stops at 1, following the convention used in most computational treatments of the Collatz sequence.
